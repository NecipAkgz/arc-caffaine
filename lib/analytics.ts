...
export function getAverageDonation(memos: Memo[]): number {
  ...
  // Optimize numeric aggregations inside loops by summing bigint values natively
  // before applying formatting utilities to avoid O(N) string and float allocations.
